...
{
    /// <inheritdoc />
    public partial class talentenportaalNovember2024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Fietsen", 0, 1 },
                    { 2, "Robots bouwen", 1, 1 },
                    { 3, "Een radiozender beginnen", 2, 1 },
                    { 4, "Pottenbakken", 3, 1 },
                    { 5, "Hiken", 4, 1 },
                    { 6, "3D-printen", 0, 2 },
                    { 7, "Doe-het-zelven", 1, 2 },
                    { 8, "Yoga", 2, 2 },
                    { 9, "Muziek luisteren", 3, 2 },
                    { 10, "Domotica", 4, 2 },
                    { 11, "Je eigen bier brouwen", 0, 3 },
                    { 12, "Tekenen", 1, 3 },
                    { 13, "Zingen", 2, 3 },
                    { 14, "Vogelspotten", 3, 3 },
                    { 15, "Meubelmaken", 4, 3 },
                    ...
                    { 17, "Schrijven", 1, 4 },
                    { 18, "Puzzelen", 2, 4 },
                    { 19, "Je eigen bier brouwen", 3, 4 },
                    { 20, "Kleding maken", 4, 4 },
                    { 21, "Tekenen", 0, 5 },
                    { 22, "Fietsen", 1, 5 },
                    { 23, "Auto’s restaureren", 2, 5 },
                    { 24, "Zeefdrukken maken", 3, 5 },
                    { 25, "Sleutelen aan fietsen", 4, 5 },
                    { 26, "Een podcast maken", 0, 6 },
                    { 27, "Drones bouwen/besturen", 1, 6 },
                    { 28, "Wandelen", 2, 6 },
                    { 29, "Naar de film gaan", 3, 6 },
                    { 30, "Puzzelen", 4, 6 },
                    { 31, "Fietsen", 0, 7 },
                    { 32, "Scrapbooking", 1, 7 },
                    { 33, "Zeep maken", 2, 7 },
                    { 34, "Lezen", 3, 7 },
                    { 35, "Cocktails maken", 4, 7 },
                    { 36, "Koken", 0, 8 },
                    { 37, "Reizen", 1, 8 },
                    { 38, "Wandelen", 2, 8 },
                    { 39, "Fietsen", 3, 8 },
            ...
            migrationBuilder.InsertData(
                schema: "TalentenPortaal",
                table: "Talent",
                columns: new[] { "Id", "AvailableHours", "ContactOptions", "CvUrl", "DateOfBirth", "Description", "DesiredWorkLocation", "Education", "FoundJob", "IsProfileVisible", "JobTitle", "LinkedInUrl", "LoopUrl", "Municipality", "Name", "OrganisationId", "PitchUrl", "ProfilePhotoRef", "Province", "TravelDistance", "WorksAtCompany" },
                values: new object[,]
                {
